...
include "../../config.php";
		$result = mysql_query("SELECT * FROM users ORDER BY name DESC")or die(mysql_error());
		$row = mysql_fetch_assoc($result);
		$z=1;
		$c=1;
?>
<center>Sorted by <font color="red"><b>NAME</b></font></center><br><hr><br>
	...
	<tbody>
		<tr>
			...
			<td scope="col" width="110">
				<p align="center">
				<b><a href="name1.php"><font color="red">Account Name</a></font></b></p></td>
