...
include "../../config.php";
		$result = mysql_query("SELECT * FROM users ORDER BY idnumber DESC")or die(mysql_error());
		$row = mysql_fetch_assoc($result);
		$z=1;
		$c=1;
?>
<center>Sorted by <font color="red"><b>IP</b></font></center><br><hr><br>
	...
	<tbody>
		<tr>
			...
			<td scope="col" width="150">
				<p align="center">
				<b><a href="ip1.php"><font color="red">IP Address</a></font></b></p></td>
			</tr>
		<tr>
			<td>
			<p align="center">
